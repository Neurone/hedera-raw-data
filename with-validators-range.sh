...
test -z "$3" && echo "Specify a command that accept a validator ID as first parameter. Omit the validator paramter (i.e., download-and-check-signatures-by-md5sum-list.sh 2024-01-01)" && exit 100
